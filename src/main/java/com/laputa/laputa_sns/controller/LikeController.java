...
public class LikeController {
    ...
    public Result<Object> createLikeRecord(@NotNull @RequestBody LikeRecord likeRecord, @PathVariable String type, @RequestAttribute Operator operator) {
    ...
    public Result<Object> deleteLikeRecord(@NotNull @RequestBody LikeRecord likeRecord, @PathVariable String type, @RequestAttribute Operator operator) {
        likeRecord.setType(typeMap.get(type));
